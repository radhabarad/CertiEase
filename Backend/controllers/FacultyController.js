...
exports.FacultySignup = async(req,res) =>{
    try{
        //get data
        const{name,email,password,facultyId,department,qualification,experience,course,areaofinterest,designation,publications} = req.body;
        //console.log({name,email,password,facultyID});

        //check if user already exist or not
        const existingUser = await Faculty.findOne({facultyId});
        //if valid entry the....
        if(existingUser){
        ...
        const faculty = await Faculty.create({
            name, email, password:hashedPassword, facultyId, department,qualification,experience,course,areaofinterest,designation,publications
        });
...
exports.FacultyLogin = async (req,res)=> {
    try{
        ...
        let user = await Faculty.findOne({facultyId});
        console.log({user});
