...
const Bonafide = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const data = await axiosInstance
      .post("/api/v1/bonafide-pdf", formData)
      .then((res) => {
        console.log({ res });
              ...
              <div className="w-full">
                {isOpen && (
                  <div className="flex flex-col text-[#EBECEF] pt-[6] w-[100%]  font-semibold text-lg  ">
                    <Link
                      className="flex flex-col  text-[#EBECEF] pt-[6] w-[100%] py-[7px] m-0 px-[12px] font-semibold text-base  bg-[#091326] hover:w-auto hover:transition-all hover:duration-700 hover:text-blue-400"
                      to="/bonafide "
                    >
              ...
              <div className="flex flex-col items-center justify-start w-full ml-[6px] text-[#cfcfcf]">
                <div className="flex w-[800px] flex-col bg-[#3139528e] justify-start mt-[30px] rounded-[20px]">
                  ...
                  <p className="text-[30px] pl-[15px] p-[10px] font-semibold">
                    Fill necessary details for Bonafide Certificate
                  </p>
...
// online interview beat..

{
  /* name = 210210107037_image */
}
...
//     console.log(formDataOld);
//     const data = await axiosInstance
//       .post("/api/v1/bonafide-pdf", formDataOld)
//       .then((res) => {
//         setStatus(res.data.message);
//       })
//       .catch((err) => {
...
//               {/* <div className=""> */}
//               <Link to="/student_dashboard">
//                 <button className="text-[#EBECEF]  w-[100%] py-[7px] px-[12px] font-semibold text-lg   hover:transition-all hover:duration-700">
//                   Dashboard
//                 </button>
//               </Link>
//               {/* </div> */}
...
//               {/* Apply thi.. */}
//               <div className="">
//                 <div className="flex items-center justify-center shadow-3xl  text-[#EBECEF] w-[100%] py-[7px] px-[12px]  font-semibold text-lg  bg-[#091326] hover:transition-all hover:duration-700">
//                   <button onClick={toggleMenu}>
//                     <div className="flex  justify-center">
//                       Apply for Certificate
//                       <RiArrowDownSLine className="mt-[6px] ml-3 text-[#EBECEF] " />
...
//               <div>
//                 {isOpen && (
//                   <div className="flex flex-col  text-[#EBECEF] pt[6] w-[100%] py-[7px] px-[12px] font-semibold text-lg  ">
//                     <Link
//                       className="flex flex-col  text-[#EBECEF] pt[6] w-[100%] py-[7px] px-[12px] font-semibold text-lg hover: hover:bg-[#091326] hover:transition-all hover:duration-700"
//                       to="/bonafide "
//                     >
...
//                     // console.log("hello");
//                   }}
//                   className=" text-[#EBECEF] w-[100%] py-[7px] px-[12px]  font-semibold text-lg bg-[#091326] hover:transition-all hover:duration-700 "
//                 >
//                   <div className="flex justify-center shadow-3xl">
//                     Apply for Certificate
//                     <RiArrowDownSLine className="mt-[6px] ml-3 text-[#EBECEF] " />
...
//                     {/* name  */}
//                     <label className="">
//                       <p className="text-[0.875rem] pl-5 pt-5 text-lg text-[#EBECEF] mb-1 leading-[1.375rem]">
//                         Name
//                         <sup className="text-pink-300"> *</sup> :
//                         <input
//                           type="text"
...
//                         >
//                           <option value="">Select Co-ordinator</option>
//                           <option value="123456789121">ABC</option>
//                           <option value="123456789123">XYZ</option>
//                         </select>
//                       </p>
//                     </label>
